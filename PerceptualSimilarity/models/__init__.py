...
import numpy as np
#from skimage.measure import compare_ssim # original version
from skimage.metrics import structural_similarity # for higher version of skimage
import torch
...
def dssim(p0, p1, range=255.):
    ...
    #return (1 - structural_similarity(p0, p1, data_range=range, multichannel=True)) / 2. ## for higher version of skimage
